...
public class CopyOfThriftTThreadPoolServer implements ThriftServer {

    private static Logger log = LoggerFactory.getLogger(CopyOfThriftTThreadPoolServer.class);
